...
function M.setup()
	...
	theme.highlights = {
		...
		NormalFloat = { fg = c.fg_main, bg = c.bg_dim }, -- Float Window.
		...
		IndentBlanklineChar = { fg = c.bg_indent_guide_inactive, nocombine = true },
		IndentBlanklineContextChar = { fg = c.bg_indent_guide_active, nocombine = true },
		IblIndent = { fg = c.bg_indent_guide_inactive, nocombine = true },
		IblScope = { fg = c.bg_indent_guide_active, nocombine = true },
		...
		MiniIndentscopeSymbol = { fg = c.bg_indent_guide_active, nocombine = true },
