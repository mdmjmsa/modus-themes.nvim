...
function M.setup()
	...
	theme.highlights = {
		...
		-- Identifiers
		["@variable"] = { fg = c.fg_main }, -- Any variable name that does not have another highlight.
		...
		["@lsp.type.qualifier"] = { link = "@keyword" },
		...
		-- snacks.nvim
		SnacksIndent = { fg = c.fg_indent_guide_inactive, nocombine = true },
		SnacksIndentHunk = { fg = c.fg_indent_guide_hunk, nocombine = true },
		SnacksIndentScope = { fg = c.fg_indent_guide_active, nocombine = true },
